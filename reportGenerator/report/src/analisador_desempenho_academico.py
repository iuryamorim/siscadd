...
from reportGenerator.report.src.aluno import Aluno
...
class AnalisadorDesempenhoAcademico(object):
    ...
    def construir_mapa_alunos(planilha):
        ...
        '''
        Note que apenas alunos que fizeram matricula (mesmo que seja de 
    ...
    def construir_mapas_periodos(planilha, mapa_alunos):
        ...
        conjunto_trancamentos_por_aluno_e_por_periodo = []
    ...
    def construir_mapas_reprovacoes(planilha, mapa_alunos):
        ...
        for line in planilha:
            ...
            nome_disciplina = line["NOME_DISCIPLINA"].decode('latin-1')
            matr_aluno = line["MATR_ALUNO"]
...
#             print matr_aluno
        ...
        return (mapa_de_aluno_para_qtd_max_de_reprovacoes_em_uma_disciplina, mapa_aluno_e_disciplina_para_qtd_reprovacoes)
