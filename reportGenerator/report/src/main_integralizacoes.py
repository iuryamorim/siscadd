...
def processar_integralizacoes(planilha, name, outputdir):
    sigla_curso = name
    ...
    filename = name + '-periodos-cursados.xlsx'
...
def main(dic, name, outputdir, ano, periodo):
    ...
    print('Iniciando processamento do arquivo %s...' % dic)
    processar_integralizacoes(dic, name, outputdir)
